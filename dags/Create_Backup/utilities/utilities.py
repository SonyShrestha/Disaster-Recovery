...
from Create_Backup.html_template.email_template import *
...
def notify_email_success(contextDict, **kwargs):
    ...
    # email title.
    title = "{} Create_Backup: {} {}".format(CLIENT,contextDict['task'].task_id,success_title)
...
def notify_email_failure(contextDict, **kwargs):
    ...
    # email title.
    title = "{} Create_Backup: {} {}".format(CLIENT,contextDict['task'].task_id,failure_title)
